namespace MassTransit
{
    ...
    public static class ScalewaySnsSendContextExtensions
    {
        /// <summary>
        ...
        {
            if (!context.TryGetPayload(out ScalewaySnsSendContext sendContext))
                throw new ArgumentException("The ScalewaySnsSendContext was not available");
