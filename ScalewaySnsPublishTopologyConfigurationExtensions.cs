...
namespace MassTransit
{
    ...
    public static class ScalewaySnsPublishTopologyConfigurationExtensions
    {
        /// <summary>
        ...
        public static void AddPublishMessageTypesFromNamespaceContaining<T>(this IScalewaySnsBusFactoryConfigurator configurator,
            Action<IScalewaySnsMessagePublishTopologyConfigurator, Type>? configure = null, Func<Type, bool>? filter = null)
        {
        ...
        /// <param name="configure"></param>
        /// <param name="filter"></param>
        public static void AddPublishMessageTypesFromNamespaceContaining(this IScalewaySnsBusFactoryConfigurator configurator, Type type,
            Action<IScalewaySnsMessagePublishTopologyConfigurator, Type>? configure = null, Func<Type, bool>? filter = null)
        {
            if (type == null)
        ...
        /// <param name="configure"></param>
        public static void AddPublishMessageTypes(this IScalewaySnsBusFactoryConfigurator configurator, IEnumerable<Type> messageTypes,
            Action<IScalewaySnsMessagePublishTopologyConfigurator, Type>? configure = null)
        {
