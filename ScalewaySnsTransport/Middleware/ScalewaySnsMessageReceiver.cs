namespace MassTransit.ScalewaySnsTransport.Middleware
{
    ...
    /// <summary>
    /// Receives messages from ScalewaySns, pushing them to the InboundPipe of the service endpoint.
    /// </summary>
    public sealed class ScalewaySnsMessageReceiver :
        ConsumerAgent<string>
    {
        ...
        public ScalewaySnsMessageReceiver(ClientContext client, SqsReceiveEndpointContext context)
        ...
        async Task Consume()
        {
            ...
            {
                var lockContext = new ScalewaySnsReceiveLockContext(_context.InputAddress, message, _receiveSettings, _client);
        ...
        async Task HandleMessage(Message message, ReceiveLockContext lockContext)
        {
            ...
            var context = new ScalewaySnsReceiveContext(message, redelivered, _context, _client, _receiveSettings, _client.ConnectionContext);
            try
            {
