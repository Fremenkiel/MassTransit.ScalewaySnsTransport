namespace MassTransit.ScalewaySnsTransport
{
    ...
    public class ScalewaySnsReceiveLockContext :
        ReceiveLockContext
    {
        ...
        public ScalewaySnsReceiveLockContext(Uri inputAddress, Message message, ReceiveSettings settings, ClientContext clientContext)
        {
