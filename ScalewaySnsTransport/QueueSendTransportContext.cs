namespace MassTransit.ScalewaySnsTransport
{
        ...
        SendTransportContext<ClientContext>
    {
        ...
        public QueueSendTransportContext(IScalewaySnsHostConfiguration hostConfiguration, ReceiveEndpointContext receiveEndpointContext,
        ...
        {
            var sendContext = new ScalewaySnsMessageSendContext<T>(message, cancellationToken);
        ...
        public async Task Send<T>(ClientContext transportContext, SendContext<T> sendContext)
            where T : class
        {
            ScalewaySnsMessageSendContext<T> context = sendContext as ScalewaySnsMessageSendContext<T>
