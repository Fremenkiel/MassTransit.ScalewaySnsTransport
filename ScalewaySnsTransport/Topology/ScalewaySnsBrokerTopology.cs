namespace MassTransit.ScalewaySnsTransport.Topology
{
    ...
    public class ScalewaySnsBrokerTopology :
        BrokerTopology
    {
        public ScalewaySnsBrokerTopology(IEnumerable<Topic> exchanges, IEnumerable<Queue> queues, IEnumerable<QueueSubscription> queueSubscriptions,
