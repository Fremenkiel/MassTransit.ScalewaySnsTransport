namespace MassTransit.ScalewaySnsTransport.Topology
{
    ...
    public class QueueReceiveSettings :
        ...
        ReceiveSettings
    {
        readonly IScalewaySnsEndpointConfiguration _configuration;

        public QueueReceiveSettings(IScalewaySnsEndpointConfiguration configuration, string queueName, bool durable, bool autoDelete)
